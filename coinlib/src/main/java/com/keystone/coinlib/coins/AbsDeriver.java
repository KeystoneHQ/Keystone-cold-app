...
public abstract class AbsDeriver {
    public static AbsDeriver newInstance(@NonNull String coinCode) {
        try {
            ...
            else if(coinCode.equals(Coins.BTC_BITKEEP_LEGACY.coinCode())) return new BTC_LEGACY.Deriver();
            else if(coinCode.equals(Coins.BTC_BITKEEP_NESTED_SEGWIT.coinCode())) return new Btc.Deriver();
            else if(coinCode.equals(Coins.BTC_BITKEEP_NATIVE_SEGWIT.coinCode())) return new BTC_NATIVE_SEGWIT.Deriver();
            ...
            else if(Coins.isCosmosFamilyByCoinCode(coinCode)) {
