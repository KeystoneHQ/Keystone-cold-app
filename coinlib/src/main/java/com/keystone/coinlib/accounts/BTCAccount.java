...
public enum BTCAccount {
    ...
    BITKEEP_LEGACY("M/44'/0'/0'", "BitKeep Legacy", "bitkeep_legacy", "m/44'/0'/0'/0/*", Coins.BTC_BITKEEP_LEGACY.coinId()),
    BITKEEP_NESTED_SEGWIT("M/44'/0'/0'", "BitKeep Nested Segwit", "bitkeep_nested_segwit", "m/44'/0'/0'/0/*", Coins.BTC_BITKEEP_NESTED_SEGWIT.coinId()),
    BITKEEP_NATIVE_SEGWIT("M/44'/0'/0'", "BitKeep Native Segwit", "bitkeep_native_segwit", "m/44'/0'/0'/0/*", Coins.BTC_BITKEEP_NATIVE_SEGWIT.coinId()),
    ...
    public static BTCAccount ofCode(String code) {
        ...
        if (code.equals(BITKEEP_LEGACY.code)) return BITKEEP_LEGACY;
        if (code.equals(BITKEEP_NATIVE_SEGWIT.code)) return BITKEEP_NATIVE_SEGWIT;
        if (code.equals(BITKEEP_NESTED_SEGWIT.code)) return BITKEEP_NESTED_SEGWIT;
