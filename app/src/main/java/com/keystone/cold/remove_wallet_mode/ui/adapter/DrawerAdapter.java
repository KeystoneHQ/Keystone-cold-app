...
import com.keystone.cold.databinding.ItemDrawerBinding;
...
public class DrawerAdapter extends RecyclerView.Adapter<DrawerAdapter.Holder> {
    ...
    private final List<DrawerItem> dataList = Arrays.asList(
            new DrawerItem(R.id.drawer_wallet, R.drawable.drawer_wallet, R.string.drawer_menu_my_assets),
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemDrawerBinding binding = DataBindingUtil.inflate(
    ...
    static class Holder extends RecyclerView.ViewHolder {
        final ItemDrawerBinding binding;

        Holder(ItemDrawerBinding binding) {
