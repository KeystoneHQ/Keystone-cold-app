...
public class BitcoinBitKeepLegacyAddressGenerator extends BaseAddressGenerator{
    public BitcoinBitKeepLegacyAddressGenerator() {
        this.coinId = Coins.BTC_BITKEEP_LEGACY.coinId();
    }
