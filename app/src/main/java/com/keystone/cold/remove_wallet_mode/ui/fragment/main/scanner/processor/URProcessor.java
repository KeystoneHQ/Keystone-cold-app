...
public class URProcessor implements Processor{
    ...
    interface URResolver {
        ProcessorManager.ProcessorDestination run(Object object) throws BaseException;
    }
    ...
    private static class AptosSignRequestProcessor implements URResolver {
        ...
        @Override
        public ProcessorManager.ProcessorDestination run(Object object) throws BaseException {
            ...
            switch (dataType) {
                case MESSAGE:
                    return new ProcessorManager.ProcessorDestination(R.id.action_to_aptosMessageFragment, bundle);
                case SINGLE:
                    ...
                    if (type == AptosTransactionHelper.Type.MESSAGE) {
                        ...
                        return new ProcessorManager.ProcessorDestination(R.id.action_to_aptosConfirmTransactionFragment, bundle);
                    }
                case MULTI:
            }
            throw UnimplementedException.newInstance();
