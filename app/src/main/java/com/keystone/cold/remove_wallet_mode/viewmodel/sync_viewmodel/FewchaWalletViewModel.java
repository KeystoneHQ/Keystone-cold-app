...
public class FewchaWalletViewModel extends AndroidViewModel {
    ...
    private List<SyncInfo> getSyncInfos() {
        List<AddressEntity> addressEntities = MainApplication.getApplication().getRepository().loadAddressSync(Coins.APTOS.coinId());
    ...
    private boolean filterSomeAddress(AddressEntity addressEntity) {
