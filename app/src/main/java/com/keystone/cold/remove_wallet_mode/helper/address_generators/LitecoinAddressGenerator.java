...
public class LitecoinAddressGenerator extends BaseAddressGenerator {
    public static final String PATH = "M/49'/2'/0'";

    public LitecoinAddressGenerator() {
        coinId = Coins.LTC.coinId();
    }
