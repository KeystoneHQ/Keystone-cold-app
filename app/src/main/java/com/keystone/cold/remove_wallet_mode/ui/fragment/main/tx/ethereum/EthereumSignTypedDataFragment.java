...
public class EthereumSignTypedDataFragment extends BaseFragment<FragmentEthereumSignTypedDataBinding> {
        ...
        if (jsonObject != null) {
            try {
                ...
                if (isLegacy) {
                    ...
                    mBinding.network.setText(EthereumTxViewModel.getNetwork(domain.optLong("chainId", 1)));
    ...
    private void updateVerifyingContract(String verifyingContract) {
        ...
        String ens = EthereumTxViewModel.loadEnsAddress(verifyingContract);
        String addressSymbol = EthereumTxViewModel.recognizeAddress(null, verifyingContract);
...
//            verifyingContract = verifyingContract + String.format(" [%s]", "Unknown Address");
    ...
    private String recognizeAddressInText(String text) {
        ...
        while (matcher.find()) {
            ...
            String symbol = EthereumTxViewModel.recognizeAddress(null, address);
            if (symbol == null) {
