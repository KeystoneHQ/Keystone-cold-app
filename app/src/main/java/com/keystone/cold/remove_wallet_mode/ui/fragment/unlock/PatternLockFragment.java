...
import static com.keystone.cold.remove_wallet_mode.ui.fragment.setup.PreImportFragment.ACTION;
import static com.keystone.cold.remove_wallet_mode.ui.fragment.setup.PreImportFragment.ACTION_RESET_PWD;
...
import com.keystone.cold.databinding.FragmentPatternLockBinding;
...
public class PatternLockFragment extends BaseFragment<FragmentPatternLockBinding> {
    ...
    protected void init(View view) {
        NFTAwareToolbarFragment nftAwareToolbarFragment = new NFTAwareToolbarFragment(false, getString(R.string.pattern_lock), R.dimen.dp_140, R.dimen.dp_30);
