...
import static com.keystone.cold.remove_wallet_mode.ui.fragment.setup.SetPasswordFragment.PASSWORD;
...
public class SetupVaultActivity extends FullScreenActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DataBindingUtil.setContentView(this, R.layout.activity_setup_vault_remove_wallet_mode);
    ...
    private void setupNavController(Bundle savedInstanceState) {
        ...
        NavGraph graph = inflater.inflate(R.navigation.nav_graph_setup_remove_wallet_mode);
