...
public class SolanaReviewTransactionFragment extends ReviewTransactionFragment<SolanaTxViewModel> {
    ...
    protected TabLayoutConfig[] getTabLayouts() {
        ...
        tabLayoutConfigs[3] = new TabLayoutConfig(getString(R.string.qr), SolSignResultFragment.newInstance(requireArguments(), viewModel.getParsedTxData()));
