...
public abstract class ListPreferenceFragment
        extends BaseFragment<FragmentListPreferenceBinding> implements ListPreferenceCallback {
    ...
    protected int setView() {
        return R.layout.fragment_list_preference;
    }
    ...
    protected class Adapter extends BaseBindingAdapter<CharSequence, ViewSettingItemSelectableBinding> {
        ...
        protected int getLayoutResId(int viewType) {
            return R.layout.view_setting_item_selectable;
        }
        ...
        @Override
        protected void onBindItem(ViewSettingItemSelectableBinding binding, CharSequence item) {
        }
    }
}
