...
public class TronAddressGenerator extends BaseAddressGenerator{
    public static final String PATH = "M/44'/195'/0'";

    public TronAddressGenerator() {
        coinId = Coins.TRON.coinId();
    }
