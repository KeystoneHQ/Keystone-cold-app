...
public class Utilities {
    ...
    public static boolean hasUserClickCoreWalletSyncLock(Context context) {
        SharedPreferences sp = context.getSharedPreferences(PREFERENCE_SECRET, MODE_PRIVATE);
        return sp.getBoolean(PREFERENCE_CORE_WALLET_KEY_SYNCED, false);
    }

    public static void setUserClickCoreWalletSyncLock(Context context) {
        SharedPreferences sp = context.getSharedPreferences(PREFERENCE_SECRET, MODE_PRIVATE);
        sp.edit().putBoolean(PREFERENCE_CORE_WALLET_KEY_SYNCED, true).apply();
    }
